...
- Troubleshooting note: If you decided to make your post an .Rmd document, make sure to commit the `.html` file that appears in your `content/` when you build/serve your site.
